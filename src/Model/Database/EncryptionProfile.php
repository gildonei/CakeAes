...
class EncryptionProfile
{
    public static function key(Connection $connection): string
    {
        ...
        $profile = Configure::read('CakeAes.profile', 'legacy');
        ...
        if (stripos((string)$version, 'MariaDB') !== false) {
            ...
            if (Configure::read('CakeAes.expectedMode', 'aes-128-ecb') !== 'aes-128-ecb') {
            ...
            $expected = Configure::read('CakeAes.expectedMode');
